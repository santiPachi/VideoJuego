...
using UnityEngine;
    ...
    public class WheelEffects : MonoBehaviour
    {
        ...
        {
             skidParticles.transform.position = transform.position;
        ...
        {
            skidding = true;
            Transform skid = SkidTrailPrefab;
            skid.localScale = new Vector3(0.1f,0.1f,0.1f);
            m_SkidTrail = Instantiate(skid);
